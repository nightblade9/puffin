...
namespace Puffin.Core.Ecs
{
    ...
    public static class EntityExtensions
    {
        ...
        /// </summary>
        public static Entity Mouse(this Entity entity, int width, int height, Action<int, int> onClick, Action onRelease = null)
        {
            if (width <= 0 || height <= 0)
            {
            ...
            entity.Set(new MouseComponent(entity, width, height, onClick, onRelease));
            return entity;
        }
